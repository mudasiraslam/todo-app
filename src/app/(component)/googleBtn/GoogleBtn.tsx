...
function GoogleBtn() {
    ...
    return (
        <>
            <button className=' text-orange-500 w-full font-plex-mono mt-9 bg-[#232020] flex items-center p-2 border-customOrange border-2 rounded-[30px]' onClick={signInWithGoogle}>
