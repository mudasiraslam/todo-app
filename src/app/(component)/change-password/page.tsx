                    ...
                    <div className="max-w-[330px] mx-auto space-y-4 md:space-y-4 py-12">
                        <div>
                            ...
                            <InputField
                                ...
                                className={`w-full placeholder-plex-mono 
                                    bg-transparent border-4 focus:outline-none 
                                    hover:outline-none px-5 py-2 rounded-[30px] 
                                     md:max-w-[555px] md:max-h-[113px] ${currentTheme?.textClass || `${color.defaultVibrantText}`}
                                      ${currentTheme?.borderClass || `${color.defaultVibrantBorder}`}`}
                            />
                        </div>
                        <div>
                            ...
                            <InputField
                                ...
                                className={`w-full placeholder-plex-mono bg-transparent border-4 py-2 px-5
                                     rounded-[30px] md:max-w-[447px] md:max-h-[113px]
                                      ${currentTheme?.textClass || `${color.defaultVibrantText}`} 
                                      ${currentTheme?.borderClass || `${color.defaultVibrantBorder}`}`}
                            />
                        </div>
                        <div className='py-3'>
                            <button
                                ...
                                disabled={loading}
                                className={`rounded-full px-5 py-2 bg-transparent border-4 w-full
                                     font-medium mb-3 
                                     ${currentTheme?.borderClass || `${color.defaultVibrantBorder}`}
                                      ${currentTheme?.textClass || `${color.defaultVibrantText}`}`}
                            >
