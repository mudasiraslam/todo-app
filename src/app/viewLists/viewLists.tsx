...
const ViewLists = () => {
    ...
    return (
        <main className={`bg-custom-radical bg-dotted-size min-h-screen ${color.bgColor}`}>
            <div
                className={`bg-dotted-size backdrop-blur-backdropBlur bg-blend-overlay py-6 pl-6 flex justify-between items-center p-6 ${color.textInput}`}
            >
            ...
            <div className="max-w-[633px] mx-auto">
                ...
                <GetTodo />
                <Link href="/add-todo">
                    <button className={`mt-5 text-sm md:text-2xl font-medium rounded-full ${color.textInput}`}>
                        + Add List.
                    </button>
                </Link>
            </div>
